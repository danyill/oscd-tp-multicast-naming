...
<Private type="Transpower-VLAN-Allocation" etpc:lastUpdated="2023-08-16:23:59:00">
      <etpc:Station>
          ...
          <etpc:VLAN serviceName="VTSel" prot1Id="1001" prot2Id="2001"/>
      </etpc:Station>
      <etpc:Bus>
          <etpc:VLAN serviceName="ARecl" prot1Id="50" prot2Id="50"/>
          <etpc:VLAN serviceName="Ctl/Ind/Test" prot1Id="100" prot2Id="200"/>
          <etpc:VLAN serviceName="Bus" prot1Id="150" prot2Id="250"/>
      </etpc:Bus>
  </Private>
----

Further requirements from development:

* VLANs will always be incremented in pairs (whether or not they are required by both protection systems, they will be allocated for both).
* VLANs will have a fixed increment between Prot1 and Prot2.
