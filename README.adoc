...
*** `BusSV` -- No identified suffix -- Belongs to the bus
*** `VTSelBus` -- Belongs to the bus
*** `VTSelStn` -- Belongs to the station
...
* VLANs will initially be unallocated (i.e. set to a disabled VLAN, e.g. 999).
